    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <span className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm font-bold mb-6 tracking-wider uppercase border border-white/20">
              <Settings2 className="w-4 h-4 text-[#8bf8ba]" />
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-black text-[#001c3b] mb-8 text-center">Prozessintegration auf einen Blick</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#f7f9fb] p-6 rounded-2xl border border-gray-100">
              <Clock className="w-8 h-8 text-[#004888] mb-4" />
              <h3 className="font-bold text-lg mb-2 text-[#001c3b]">Perfektes Timing</h3>
            ...
            <div className="bg-[#f7f9fb] p-6 rounded-2xl border border-gray-100">
              <ShieldAlert className="w-8 h-8 text-[#2ca06a] mb-4" />
              <h3 className="font-bold text-lg mb-2 text-[#001c3b]">Maximale Sicherheit</h3>
            ...
            <div className="bg-[#f7f9fb] p-6 rounded-2xl border border-gray-100">
              <Zap className="w-8 h-8 text-[#004888] mb-4" />
      ...
      <section className="py-20 lg:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none text-[#424751] leading-relaxed">
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Die Herausforderung: Reinigung vs. Produktion</h2>
            <p className="mb-8">
              In der <Link to="/branchen/industrie-produktion" className="text-[#004888] font-bold hover:underline">Industrie und Produktion</Link> ist Zeit Geld. Jede Minute Stillstand kostet. 
              Gleichzeitig ist Sauberkeit oft die Grundvoraussetzung für Produktqualität, Maschineneffizienz 
              und Arbeitssicherheit. Die Lösung für diesen scheinbaren Widerspruch liegt in der perfekten Integration der <Link to="/leistungen/industrie-produktionsreinigung" className="text-[#004888] font-bold hover:underline">Industriereinigung</Link> in die bestehenden Betriebsabläufe.
            </p>

            <div className="bg-[#001c3b] text-white p-8 rounded-3xl mb-12 shadow-xl">
              <h3 className="text-2xl font-bold text-[#8bf8ba] mb-6 flex items-center gap-3">
                <Zap className="text-[#8bf8ba] w-8 h-8" />
            ...
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Sicherheit an erster Stelle</h2>
            <p className="mb-6">
            ...
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Technik & Know-how für den laufenden Betrieb</h2>
            <p className="mb-6">
            ...
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Fazit: Reinigung als Wertschöpfung</h2>
            <p className="mb-8">
