    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <span className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm font-bold mb-6 tracking-wider uppercase border border-white/20">
              <BookOpen className="w-4 h-4 text-[#8bf8ba]" />
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-black text-[#001c3b] mb-8 text-center">Reinigungsintervalle auf einen Blick</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#f7f9fb] p-6 rounded-2xl border border-gray-100">
              <Clock className="w-8 h-8 text-[#004888] mb-4" />
              <h3 className="font-bold text-lg mb-2 text-[#001c3b]">Tägliche Reinigung</h3>
            ...
            <div className="bg-[#f7f9fb] p-6 rounded-2xl border border-gray-100">
              <Calendar className="w-8 h-8 text-[#2ca06a] mb-4" />
              <h3 className="font-bold text-lg mb-2 text-[#001c3b]">Wöchentliche Reinigung</h3>
            ...
            <div className="bg-[#f7f9fb] p-6 rounded-2xl border border-gray-100">
              <BookOpen className="w-8 h-8 text-[#004888] mb-4" />
              <h3 className="font-bold text-lg mb-2 text-[#001c3b]">Monatliche Reinigung</h3>
      ...
      <section className="py-20 lg:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none text-[#424751] leading-relaxed">
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Die Bedeutung der richtigen Taktung in der Unterhaltsreinigung</h2>
            <p className="mb-8">
              In der <Link to="/leistungen/unterhaltsreinigung" className="text-[#004888] font-bold hover:underline">Unterhaltsreinigung</Link> ist das Intervall der entscheidende Hebel für 
            ...
            <div className="bg-[#f7f9fb] p-8 rounded-3xl mb-12 border border-gray-100 shadow-sm">
              <h3 className="text-2xl font-bold text-[#001c3b] mb-6 flex items-center gap-3">
                <Calendar className="text-[#004888] w-8 h-8" />
              ...
              <ul className="space-y-4 list-none pl-0">
                <li className="flex flex-col sm:flex-row gap-2 sm:gap-4 border-b border-gray-200 pb-4">
                  <span className="font-bold text-[#004888] min-w-[120px]">Täglich:</span>
                  <span>Sanitärräume, Küchenbereiche, stark frequentierte Flure, Empfang, Müllentsorgung.</span>
                </li>
                <li className="flex flex-col sm:flex-row gap-2 sm:gap-4 border-b border-gray-200 pb-4">
                  <span className="font-bold text-[#004888] min-w-[120px]">2-3x pro Woche:</span>
                  <span>Büroarbeitsplätze (Schreibtische), Staubsaugen in weniger genutzten Bereichen, Besprechungsräume.</span>
                </li>
                <li className="flex flex-col sm:flex-row gap-2 sm:gap-4 border-b border-gray-200 pb-4">
                  <span className="font-bold text-[#004888] min-w-[120px]">Wöchentlich:</span>
                ...
                <li className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                  <span className="font-bold text-[#004888] min-w-[120px]">Monatlich:</span>
                  <span>Spinnweben entfernen, Reinigung von Fußleisten, Heizkörpern, Polstermöbelpflege.</span>
                </li>
              </ul>
            </div>

            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Welche Faktoren beeinflussen die Intervallplanung?</h2>
            <p className="mb-6">
              Ein professionelles Reinigungsunternehmen erstellt nicht einfach einen Standardplan. Bei der Erstellung eines Leistungsverzeichnisses für die <Link to="/branchen/buero-verwaltung" className="text-[#004888] font-bold hover:underline">Büroreinigung</Link> berücksichtigen wir 
            ...
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Fazit: Dynamik schlägt Statik</h2>
            <p className="mb-8">
      ...
      <section className="py-20 lg:py-32 bg-[#f7f9fb]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight text-[#001c3b]">FAQs zu Reinigungsintervallen</h2>
          </div>
