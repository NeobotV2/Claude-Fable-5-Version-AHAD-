        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <span className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm font-bold mb-6 tracking-wider uppercase border border-white/20">
              <RefreshCw className="w-4 h-4 text-[#8bf8ba]" />
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-[#f7f9fb] p-8 md:p-12 rounded-3xl border border-gray-100 flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1">
              <h2 className="text-2xl font-black text-[#001c3b] mb-6">Der Wechsel in 30 Sekunden</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 text-sm font-bold text-[#001c3b]">
                  <CheckCircle2 className="text-[#2ca06a] w-5 h-5" /> Kündigungsfristen prüfen
                </div>
                <div className="flex items-center gap-3 text-sm font-bold text-[#001c3b]">
                  <CheckCircle2 className="text-[#2ca06a] w-5 h-5" /> LV neu definieren
                </div>
                <div className="flex items-center gap-3 text-sm font-bold text-[#001c3b]">
                  <CheckCircle2 className="text-[#2ca06a] w-5 h-5" /> Referenzen prüfen
                </div>
                <div className="flex items-center gap-3 text-sm font-bold text-[#001c3b]">
                  <CheckCircle2 className="text-[#2ca06a] w-5 h-5" /> Übergabe planen
                </div>
              </div>
            </div>
            <div className="w-full md:w-64 flex-shrink-0">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
                ...
                <p className="text-sm font-bold text-[#001c3b]">Kündigen Sie erst, wenn der neue Vertrag unterschrieben ist!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 lg:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none text-[#424751] leading-relaxed">
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Wann ist ein Wechsel der Reinigungsfirma notwendig?</h2>
            <p className="mb-8">
            ...
            <h3 className="text-2xl font-bold text-[#001c3b] mb-6">Die 5 häufigsten Warnsignale:</h3>
            ...
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Schritt-für-Schritt zum neuen Partner</h2>
            
            <div className="space-y-12 my-12">
              <div className="relative pl-12 border-l-2 border-gray-100">
                <div className="absolute -left-[13px] top-0 w-6 h-6 bg-[#004888] rounded-full border-4 border-white shadow-sm"></div>
                <h4 className="text-xl font-bold text-[#001c3b] mb-3">1. Bestandsaufnahme & Kündigung</h4>
              ...
              <div className="relative pl-12 border-l-2 border-gray-100">
                <div className="absolute -left-[13px] top-0 w-6 h-6 bg-[#004888] rounded-full border-4 border-white shadow-sm"></div>
                <h4 className="text-xl font-bold text-[#001c3b] mb-3">2. Leistungsverzeichnis (LV) aktualisieren</h4>
              ...
              <div className="relative pl-12 border-l-2 border-gray-100">
                <div className="absolute -left-[13px] top-0 w-6 h-6 bg-[#004888] rounded-full border-4 border-white shadow-sm"></div>
                <h4 className="text-xl font-bold text-[#001c3b] mb-3">3. Marktsondierung & Begehung</h4>
              ...
              <div className="relative pl-12 border-l-2 border-gray-100">
                <div className="absolute -left-[13px] top-0 w-6 h-6 bg-[#004888] rounded-full border-4 border-white shadow-sm"></div>
                <h4 className="text-xl font-bold text-[#001c3b] mb-3">4. Angebotsprüfung & Referenzen</h4>
            ...
            <h2 className="text-3xl font-black text-[#001c3b] mb-6">Die Übergabe: Der kritische Moment</h2>
            <p className="mb-8">
      ...
      <section className="py-20 lg:py-32 bg-[#f7f9fb]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight text-[#001c3b]">FAQs zum Anbieterwechsel</h2>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-[#001c3b] text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/kontakt"
              className="inline-flex items-center px-8 py-4 bg-[#004888] text-white font-bold rounded-xl hover:bg-blue-700 border border-white/20 transition-all shadow-sm hover:shadow-md hover:-translate-y-[1px]"
            >
              Kostenlose Erstberatung
            </Link>
            <Link
              to="/ahad-system"
              className="inline-flex items-center px-8 py-4 bg-white text-[#001c3b] font-bold rounded-xl hover:bg-gray-100 transition-all shadow-lg"
            >
